...
class Etsy(BaseModule):
    def login(self, username, password, useragent):
        ...
        login_page = br.open('https://etsy.com/signin')
        ...
        # If '/signin' in the URL, the login attempt failed
        if '/signin' in login_attempt.geturl():
            return {
        ...
        # If 'show_panel' in url, login succeeded.
        elif 'show_panel' in login_attempt.geturl():
    ...
    def get_name_element(self, login_html_str):
        try:
            ...
            logged_in_name_element = login_attempt_html.xpath(
              '//*[@id="gnav-header"]/div/div/ul/li[1]/a/div/p[1]'
            )
